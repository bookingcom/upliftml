...
from upliftml.models.h2o import XLearnerEstimator
...
def test_train_model(spark: SparkSession, df_h2o_cont: h2o.H2OFrame) -> None:
    ...
    model = XLearnerEstimator(
        base_model_class_1=H2OGeneralizedLinearEstimator,
        base_model_params_1={},
        predictor_colnames_1=predictor_colnames,
        base_model_class_2=H2OGeneralizedLinearEstimator,
        base_model_params_2={},
