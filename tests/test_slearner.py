...
from upliftml.models.h2o import SLearnerEstimator
...
def test_train_model(spark: SparkSession, df_h2o_cont: h2o.H2OFrame) -> None:
    ...
    model = SLearnerEstimator(
        # using GBMs here, because S-learner doesn't work out-of-the-box with GLMs (would predict same CATE for all instances)
        base_model_class=H2OGradientBoostingEstimator,
        base_model_params={},
