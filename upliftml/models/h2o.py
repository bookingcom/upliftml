...
class UpliftRandomForestEstimator:
    ...
    def fit(self, df_h2o_train: h2o.H2OFrame, df_h2o_val: Optional[h2o.H2OFrame] = None) -> None:
        ...
        assert df_h2o_train[self.target_colname].isfactor()[0] is True, 'The target column must be categorical as the estimator only supports binomial classification.'
